...
var incompleteTaskHolder = document.getElementById("active-task"); //ul of #incompleteTasks
var completedTasksHolder = document.querySelector(".completed-section__list"); //completed-tasks

//New task list item
var createNewTaskElement = function (taskString) {
  var listItem = document.createElement("li");
  listItem.classList.add("section-link");
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("edit-input");
  ...
  listItem.classList.toggle("edit-input");
};
